...
export default function AssignPage() {
  ...
  const { data: assignedKpis, isLoading: isLoadingAssigned,isError: isErrorAssigned,error: assignedError } = useFetchAssignedKpis(assignedTabDepartment, assignedTabPillar);
  ...
  return (
    <main className="container mx-auto py-8 px-4">
      ...
      {activeTab === 'assigned' && (
         ...
         <p className="text-gray-600 mt-2">View KPIs that have already been assigned to departments and pillars.</p>
        </div>
